...
function gamipress_award_points_to_user( $user_id = 0, $points = 0, $points_type = '', $args = array() ) {
	...
	/**
     * Filter to allow award points to user
     *
     * @since 7.0.5
     *
     * @param bool      
	 ...
	 * @return bool
     */
	$allow = apply_filters( 'gamipress_allow_award_points_to_user', true, $user_id, $points, $points_type, $args );
...
function gamipress_deduct_points_to_user( $user_id = 0, $points = 0, $points_type = '', $args = array() ) {
	...
	/**
     * Filter to allow deduct points to user
     *
     * @since 7.0.5
     *
     * @param bool      
	 ...
	 * @return bool
     */
	$allow = apply_filters( 'gamipress_allow_deduct_points_to_user', true, $user_id, $points, $points_type, $args );
