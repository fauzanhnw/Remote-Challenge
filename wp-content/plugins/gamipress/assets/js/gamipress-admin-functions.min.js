...
function gamipress_select2_destroy($this,clear_options=!1){$this.removeAttr('data-select2-id');$this.removeData('data-hash');$this.next('.select2').remove();if(clear_options){$this.find('option').remove()}}
