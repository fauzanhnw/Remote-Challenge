...
/**
 * Helper function to destroy a select2 element when the method destroy does not works
 *
 * @since 1.6.6
 *
 * @param {Object} $this
 */
function gamipress_select2_destroy( $this, clear_options = false ) {
    $this.removeAttr('data-select2-id');
    $this.removeData('data-hash');
