...
function gamipress_ameliabooking_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'Amelia', 'gamipress' )] = array(
        ...
        'gamipress_ameliabooking_user_cancels_appointment'          => __( 'Cancel an appointment for any service', 'gamipress' ),
        'gamipress_ameliabooking_user_cancels_appointment_service'  => __( 'Cancel an appointment for a specific service', 'gamipress' ),
        // Events
        ...
        'gamipress_ameliabooking_user_cancels_event'            => __( 'Cancel for any event', 'gamipress' ),
        'gamipress_ameliabooking_user_cancels_specific_event'   => __( 'Cancel for a specific event', 'gamipress' ),
    );
...
function gamipress_ameliabooking_specific_activity_triggers( $specific_activity_triggers ) {
    ...
    $specific_activity_triggers['gamipress_ameliabooking_user_cancels_appointment_service'] = array( 'ameliabooking_appointment' );
    $specific_activity_triggers['gamipress_ameliabooking_user_cancels_specific_event'] = array( 'ameliabooking_event' );
...
function gamipress_ameliabooking_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    $specific_activity_trigger_labels['gamipress_ameliabooking_user_cancels_appointment_service'] = __( 'Cancel an appointment for %s service', 'gamipress' );
    $specific_activity_trigger_labels['gamipress_ameliabooking_user_cancels_specific_event'] = __( 'Cancel for %s event', 'gamipress' );
...
function gamipress_ameliabooking_specific_activity_trigger_post_title( $post_title, $specific_id, $trigger_type ) {
    ...
    switch( $trigger_type ) {
        ...
        case 'gamipress_ameliabooking_user_books_specific_event':
            ...
            break;
        case 'gamipress_ameliabooking_user_cancels_appointment_service':
            if( absint( $specific_id ) !== 0 ) {
                // Get the service title
                $service_title = gamipress_ameliabooking_get_service_title( $specific_id );
            ...
            break;
        case 'gamipress_ameliabooking_user_cancels_specific_event':
            if( absint( $specific_id ) !== 0 ) {
            // Get the event title
            $event_title = gamipress_ameliabooking_get_event_title( $specific_id );
...
function gamipress_ameliabooking_trigger_get_user_id( $user_id, $trigger, $args ) {
    ...
    switch ( $trigger ) {
        ...
        case 'gamipress_ameliabooking_user_books_appointment_service':
        case 'gamipress_ameliabooking_user_cancels_appointment':
        case 'gamipress_ameliabooking_user_cancels_appointment_service':
        // Events
        case 'gamipress_ameliabooking_user_books_event':
        case 'gamipress_ameliabooking_user_books_specific_event':
        case 'gamipress_ameliabooking_user_cancels_event':
        case 'gamipress_ameliabooking_user_cancels_specific_event':
            $user_id = $args[1];
            break;
    }
